 ...
 * already-rendered tree ourselves - this is what actually makes our overrides visible. Identical to
 * Staff Tags' own copy of this patch - fully generic, doesn't care which plugin computed the tag.
 */
export default () => {
    if (!Tag) return () => {};
