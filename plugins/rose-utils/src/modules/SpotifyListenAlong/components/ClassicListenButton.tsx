...
export default function ClassicListenButton({ button, activity }: ListenButtonProps) {
                ...
                <Button
                    ...
                    renderIcon={() =>
                        loading ? (
                            ...
                            <RN.Image source={UserPlayIcon} style={{ width: 20, height: 20, tintColor: "#fff" }} />
                        )}
                    onPress={() => !loading && (doSync(disabled, activity, userId), !disabled && trigger())}
                />
            </RN.View>
